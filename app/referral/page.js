...
export default function ReferralPage(){
 ...
 const stats=[['이번달 추천',`${Number(me?.monthly_referrals||0).toLocaleString()}명`],['누적 추천',`${Number(me?.total_referrals||0).toLocaleString()}명`],['이번달 보상',fmt(me?.monthly_reward)],['누적 보상',fmt(me?.total_reward)]];
